 ...
 */
final class Version20200623030358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tutore (id INT NOT NULL, etudiant_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE realisation (id INT NOT NULL, cours_id INT NOT NULL, titre VARCHAR(255) NOT NULL, desicription TEXT DEFAULT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, date_fin DATE NOT NULL, PRIMARY KEY(id))');
