 ...
 */
final class Version20200625164014 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT NOT NULL, realisation_id INT DEFAULT NULL, tutore_id INT DEFAULT NULL, date_inscrption DATE NOT NULL, statut INT NOT NULL, PRIMARY KEY(id))');
